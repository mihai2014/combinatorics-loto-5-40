...
class Reducere():
    ...
    def calc_intersect(self):
        ...
        #change to 0 all values < 3
        self.intersect = np.where(self.intersect < 3, 0, self.intersect)
    ...
    def diagnose(self):
        ...
        #print(self.m1Sol)
        self.rez = self.m1Sol @ self.m2.T
        #print(self.rez.shape)
        #print(self.rez)
        t = np.sum(self.rez,axis=0)
        #print(t)
